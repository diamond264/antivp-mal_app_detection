...
import kr.ac.kaist.nmsl.antivp.bcr.format.NoParamInfo
import kr.ac.kaist.nmsl.antivp.bcr.format.RangedParamInfo
import kr.ac.kaist.nmsl.antivp.bcr.format.SampleRate
import kr.ac.kaist.nmsl.antivp.R
import kr.ac.kaist.nmsl.antivp.bcr.*
...
class SettingsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = "AntiVP Call Recording Test Page"
    }
