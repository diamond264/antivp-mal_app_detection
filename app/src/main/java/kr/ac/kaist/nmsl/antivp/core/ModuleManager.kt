...
class ModuleManager {
    ...
    class ModuleHandler(module: Module) : Handler(Looper.getMainLooper()) {
        var mModule = module
    ...
    private fun sendMessage(target: String, type: EventType, bundle: Bundle) {
        ...
        Log.e("sendMessage", "Cannot find $targetModule, $type, $bundle")
    ...
    fun register(module: Module) {
        ...
        println("registered modules: ${module.name()}")
    }
