...
class DetailedVPActivity : AppCompatActivity() {
    val TAG = "Detailed Vishing activity"
...
//        val fileManager = FileManager.getInstance()
        ...
        val filePath = Paths.get(filesDir.absolutePath, "transcribed/$fileName")
